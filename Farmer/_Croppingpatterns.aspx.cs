...
{
    public partial class _Croppingpatterns : System.Web.UI.Page
    {
        ...
        {
            string FileName = "CroppingDatasets.xls";

            string Extension = ".xls";

            string FolderPath = ConfigurationManager.AppSettings["FolderPath"];

            string _Location = "CroppingDatasets.xls";
        ...
        private void EclatAlgorithm()
        {
            try
            {
                ...
                double _supportCnt = (double.Parse(lv_Transactions.Items.Count.ToString()) / 100) * 10;
        ...
        private void Import_To_Grid(string FilePath, string Extension, string _Location)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    string _transaction = dt.Rows[i]["Result"].ToString();
