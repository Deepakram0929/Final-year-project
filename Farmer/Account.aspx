<%@ Page Title="" Language="C#" MasterPageFile="~/Farmer/FarmerMP.Master" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="cropPrediction.Farmer.Account" %>
...
<div class="wrap">
<div class="main_top">
	<h4 class="style">Farmer Change Password</h4>
</div>
</div>
</div>
<!-- start main -->
			...
			<form id="registration_form" action="contact.php" method="post">
				...
				<div>
					<label>
                        ...
                        ImageUrl="~/images/pwd change.png" Width="250px" />
                    <br />
