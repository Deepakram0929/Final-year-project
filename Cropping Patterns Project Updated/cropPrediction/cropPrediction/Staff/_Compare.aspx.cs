...
namespace cropPrediction.Staff
{
    public partial class _Compare : System.Web.UI.Page
    {
        ...
        protected override void OnDataBinding(EventArgs e)
        {
            ...
            testData.Add("Eclat", _percentageKNN);
        ...
        {
            _percentageKNN = double.Parse("91.67");
            _percentageNB = double.Parse("96.0");
            ...
            cell4.Width = 200;
            cell4.Text = "<b>Eclat Algorithm</b>";
